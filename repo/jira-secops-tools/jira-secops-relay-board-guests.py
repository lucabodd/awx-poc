...
query='project = "SECOPS" AND issuetype!="Epic" AND ("Relay Board" IS NOT EMPTY) AND ("Relay Description" IS NOT EMPTY) AND ("Relay Summary" IS NOT EMPTY) AND reporter='+jira_executor_account_id
