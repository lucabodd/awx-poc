...
query='project = "COR" AND issuetype!="COR - Epic" AND ("Relay Board" IS NOT EMPTY) AND ("Relay Description" IS NOT EMPTY) AND ("Relay Summary" IS NOT EMPTY) AND ("Severity" IS NOT EMPTY)'
